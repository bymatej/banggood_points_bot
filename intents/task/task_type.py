...
class Tasks(enum.Enum):
    ...
    SEARCH_ADD_X_PRODUCTS_TO_CART = 3
...
# todo: rename (replace X)
def search_add_X_products_to_wish_list():
    return TaskData(task_type=Tasks.SEARCH_ADD_X_PRODUCTS_TO_CART, main_css_class="searchAddcart",
                    identifier_for_logging="cart")
