...
class TaskData:
    ...
    def __init__(self, task_type: TaskType, main_css_class: str, identifier_for_logging: str) -> object:
...
def browse_add_3_products_to_cart():
    return TaskData(task_type=TaskType.BROWSE_ADD_3_PRODUCTS_TO_CART, main_css_class="browseAddcart",
                    identifier_for_logging="cart")


def browse_add_3_products_to_wish_list():
    return TaskData(task_type=TaskType.BROWSE_ADD_3_PRODUCTS_TO_WISH_LIST, main_css_class="wishlist",
                    identifier_for_logging="wish list")


def search_add_products_to_wish_list():
    return TaskData(task_type=TaskType.SEARCH_ADD_PRODUCTS_TO_CART, main_css_class="searchAddcart",
                    identifier_for_logging="cart")
